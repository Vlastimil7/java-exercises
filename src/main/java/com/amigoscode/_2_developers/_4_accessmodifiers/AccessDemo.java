...
public class AccessDemo {
    ...
    public static void main(String[] args) {
        ...
        accessModifiers.setSecret("Vlastimil");
        String secret = accessModifiers.getSecret();
        ...
        /*
         * The secret field is private and belongs to the AccessModifiers class.
         * It can only be accessed directly inside that class.
         * From outside the class, we must use public methods such as a getter or setter.
         */
    }
}
