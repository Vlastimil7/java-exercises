...
class PaymentProcessor {
    ...
    void processAllPayments(List<IPayment> payments, double amount) {
...
class PaymentDemo {
    public static void main(String[] args) {
        ...
        CreditCardPayment creditCardPayment = new CreditCardPayment("100-200-300");
        PayPalPayment payPalPayment = new PayPalPayment("25kali25@gmail.com");
        BankTransferPayment bankTransferPayment = new BankTransferPayment("200VK-LS-AAAA-99");
        List<IPayment> payments = List.of(creditCardPayment, payPalPayment, bankTransferPayment);

        //   Then create a PaymentProcessor and call processAllPayments().
        PaymentProcessor paymentProcessor = new PaymentProcessor();
        paymentProcessor.processAllPayments(payments, 1000);
        ...
        //   Example:
        IPayment payment = new CreditCardPayment("1234-5678");
